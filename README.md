...
dotnet anchorgen -i target/idl/click-game.json -o target/idl/ClickGame.cs
```

(Replace click-game with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(ClickGame_PROGRAM_ID)
      );
    try {
