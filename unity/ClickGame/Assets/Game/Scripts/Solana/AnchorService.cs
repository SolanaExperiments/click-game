...
public class AnchorService : MonoBehaviour
{
    ...
    private ClickGameClient anchorClient;
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new ClickGameClient(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async Task InitAccounts(bool useSession)
    {
        ...
        var initTx = ClickGameProgram.InitPlayer(accounts, levelSeed, AnchorProgramIdPubKey);
        tx.Add(initTx);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = ClickGameProgram.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
